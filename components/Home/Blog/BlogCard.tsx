...
const BlogCard = ({ blog }: Props) => {
  ...
  return (
    <div className="bg-[#3730a3] rounded-md overflow-hidden">
      <Image
        src={image}
        alt={title}
        width={300}
      ...
      <div className="p-6">
        ...
        <div className="mt-4 mb-4 w-full h-[1.5px] bg-gray-400 opacity-45">
          <div className="flex items-center justify-between ">
            <h1 className="text-sm text-white font-bold mt-2">{date}</h1>
            <button className="text-base hover:text-rose-500 text-white underline font-bold mt-2">
              Read More
            </button>
          </div>
        </div>
